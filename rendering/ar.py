...
from rendering.model.camera import DLT, Homography
from rendering.model.reference import Reference3DCylindrical, Reference2D
from rendering.util import (
    draw_key_points,
    draw_origin,
    draw_projected_pts,
    draw_cube,
...
def stream_homography(
    pth: Union[str, int], ref_img_pth_2d: str, camera_parameters: np.ndarray
):
...
def stream_dlt(pth: Union[str, int] = 0, ref_img_pth_3d: str = None):
    cap = cv2.VideoCapture(pth)
...
if __name__ == "__main__":
    stream_dlt(
        r"C:\Users\Fuzail.Palnak\UHD\openSource\3dRendering\data\cylindrical-surface.mp4",
        ref_img_pth_3d=r"data\reference.jpg",
    )
